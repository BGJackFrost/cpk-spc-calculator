-- ============================================================
-- ALTER PostgreSQL Schema to Match MySQL Production
-- ============================================================
-- Script này thêm các cột còn thiếu vào PostgreSQL tables
-- để match với MySQL production schema
-- ============================================================

-- Users table - thêm các cột còn thiếu
...
AND table_name IN ('users', 'local_users', 'machines', 'oee_records', 'licenses')
