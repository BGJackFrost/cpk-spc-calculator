...
const menuGroups: MenuGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { icon: Key, labelKey: "nav.licenseActivation", path: "/license-activation" },
      { icon: Key, labelKey: "nav.licenseAdmin", path: "/license-admin", adminOnly: true },
...
const fallbackLabelsVi: Record<string, string> = {
  ...
  "nav.licenseAdmin": "Quản lý License",
...
const fallbackLabelsEn: Record<string, string> = {
  ...
  "nav.licenseAdmin": "License Admin",
