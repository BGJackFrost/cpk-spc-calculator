...
const mockComparisonData = {
  models: [
    {
      ...
      memoryUsage: 256,
      trainingTime: "45 min",
      dataSize: "50K samples",
      lastUpdated: "25/12/2024",
      status: "production",
    },
    {
      id: "model-002",
      name: "CPK Predictor v2.0",
      type: "XGBoost",
      version: "2.0.0",
      accuracy: 0.91,
      precision: 0.89,
      ...
      memoryUsage: 280,
      trainingTime: "50 min",
      dataSize: "45K samples",
      lastUpdated: "20/12/2024",
      status: "staging",
    },
    {
      id: "model-003",
      name: "CPK Predictor LSTM",
      type: "LSTM",
      version: "1.0.0",
      accuracy: 0.89,
      precision: 0.87,
  ...
  radarData: [
    { metric: "Accuracy", "v2.1": 94, "v2.0": 91, "LSTM": 89, "RF": 88 },
    { metric: "Precision", "v2.1": 92, "v2.0": 89, "LSTM": 87, "RF": 86 },
    { metric: "Recall", "v2.1": 91, "v2.0": 88, "LSTM": 90, "RF": 85 },
    { metric: "F1 Score", "v2.1": 91.5, "v2.0": 88.5, "LSTM": 88.5, "RF": 85.5 },
    { metric: "Speed", "v2.1": 85, "v2.0": 80, "LSTM": 60, "RF": 90 },
  ],
  performanceHistory: [
    { date: "01/12", "v2.1": 92, "v2.0": 90, "LSTM": 87, "RF": 86 },
    { date: "08/12", "v2.1": 93, "v2.0": 90, "LSTM": 88, "RF": 87 },
    { date: "15/12", "v2.1": 93.5, "v2.0": 91, "LSTM": 88.5, "RF": 87.5 },
    { date: "22/12", "v2.1": 94, "v2.0": 91, "LSTM": 89, "RF": 88 },
  ],
  latencyComparison: [
    { name: "v2.1 XGBoost", latency: 45, color: "#22c55e" },
    { name: "v2.0 XGBoost", latency: 52, color: "#3b82f6" },
    { name: "LSTM", latency: 85, color: "#f97316" },
    { name: "Random Forest", latency: 38, color: "#8b5cf6" },
  ],
};
