...
const mockInsightsData = {
  ...
  categories: [
    { name: "Quality", count: 15, color: "blue" },
    { name: "Efficiency", count: 12, color: "green" },
    { name: "Maintenance", count: 10, color: "orange" },
    { name: "Cost", count: 10, color: "purple" },
  ],
  insights: [
    {
      id: 1,
      title: "Tối ưu nhiệt độ Line 1 để tăng CPK",
      description: "Phân tích dữ liệu 30 ngày cho thấy tăng nhiệt độ từ 185°C lên 192°C có thể cải thiện CPK từ 1.25 lên 1.38.",
      category: "Quality",
      priority: "high",
      impact: "+10.4% CPK",
      confidence: 0.92,
    ...
    {
      id: 2,
      title: "Giảm thời gian downtime Line 2",
      description: "Phát hiện pattern downtime lặp lại vào thứ 2 hàng tuần. Đề xuất bảo trì phòng ngừa vào Chủ nhật.",
      category: "Efficiency",
      priority: "high",
      impact: "+5.2% OEE",
      confidence: 0.88,
    ...
    {
      id: 3,
      title: "Thay thế dao cắt trước khi hết tuổi thọ",
      description: "Dự báo dao cắt máy CNC-03 sẽ đạt giới hạn mòn trong 3 ngày. Đề xuất thay thế sớm để tránh defect.",
    ...
    {
      id: 4,
      title: "Tối ưu lịch sản xuất để giảm chi phí năng lượng",
      description: "Chuyển 30% sản lượng sang ca đêm có thể tiết kiệm 15% chi phí điện do giá điện thấp hơn.",
      category: "Cost",
      priority: "medium",
      impact: "-15% Energy Cost",
      confidence: 0.78,
      status: "new",
    ...
    {
      id: 5,
      title: "Điều chỉnh áp suất để giảm lỗi bề mặt",
      description: "Tương quan mạnh giữa áp suất và lỗi bề mặt. Tăng áp suất 0.3 bar có thể giảm 40% lỗi surface.",
      category: "Quality",
      priority: "high",
      impact: "-40% Surface Defect",
      confidence: 0.91,
      status: "reviewing",
  ...
  trends: [
    { date: "20/12", insights: 5, implemented: 2 },
    { date: "21/12", insights: 8, implemented: 3 },
    { date: "22/12", insights: 6, implemented: 4 },
    { date: "23/12", insights: 10, implemented: 5 },
    { date: "24/12", insights: 9, implemented: 2 },
    { date: "25/12", insights: 9, implemented: 2 },
  ],
};
